...
namespace rml::qt
{
	...
	{
		static const auto fn = detail::widgets<void (*)(void*, void*, int, int)>("QBoxLayout::addWidget(QWidget*, int, QFlags<Qt::AlignmentFlag>)");
		if (fn && widget)
	...
	{
		static const auto fn = detail::widgets<void (*)(void*, int, void*, int, int)>("QBoxLayout::insertWidget(int, QWidget*, int, QFlags<Qt::AlignmentFlag>)");
		if (fn && widget)
	...
	{
		static const auto fn = detail::widgets<void (*)(void*, int, int, int, int)>("QLayout::setContentsMargins(int, int, int, int)");
		if (fn)
	...
	{
		static const auto construct = detail::widgets<void* (*)(void*, void*)>("QVBoxLayout::QVBoxLayout(QWidget*)");
	...
	{
		static const auto construct = detail::widgets<void* (*)(void*, void*)>("QHBoxLayout::QHBoxLayout(QWidget*)");
