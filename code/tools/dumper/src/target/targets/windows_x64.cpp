...
namespace rml::dumper::target
{
	static constexpr std::array<AnchorSpec, anchor_count> windows_x64_anchors{{
	    ...
	    {Anchor::lua_settop, "48 89 5C 24 ? 57 48 83 EC 20 4C 8B 41 ? 48 8B D9 48 63 FA 85 D2"},
	    ...
	    {Anchor::lua_pushnumber, "40 53 48 83 EC 30 48 8B D9 0F 29 74 24 ? 48 8B 49 ? 0F 28 F1 48 8B 43"},
